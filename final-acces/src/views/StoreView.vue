      ...
      <div class="flex justify-center gap-10 mt-30">
        ...
        <div class="w-[650px] h-[470px] bg-black/70 rounded-lg border-2 border-gray-500 p-8">
          ...
          <div class="grid grid-cols-4 gap-8">
            <button
              @click="seleccionarPersonaje('samurai')"
              class="w-32 h-32 bg-[#161C37] rounded-xl border-2 border-[#45495C] flex flex-col items-center justify-center transition-all duration-300 hover:border-fuchsia-500 hover:shadow-[inset_0_0_20px_#FB00FF] hover:-translate-y-2"
            >
            ...
            <button
              @click="seleccionarPersonaje('nomada')"
              class="w-32 h-32 bg-[#161C37] rounded-xl border-2 border-[#45495C] flex flex-col items-center justify-center transition-all duration-300 hover:border-fuchsia-500 hover:shadow-[inset_0_0_20px_#FB00FF] hover:-translate-y-2"
            >
            ...
            <button
              @click="seleccionarPersonaje('pirata')"
              class="w-32 h-32 bg-[#161C37] rounded-xl border-2 border-[#45495C] flex flex-col items-center justify-center transition-all duration-300 hover:border-fuchsia-500 hover:shadow-[inset_0_0_20px_#FB00FF] hover:-translate-y-2"
            >
            ...
            <button
              @click="seleccionarPersonaje('selva')"
              class="w-32 h-32 bg-[#161C37] rounded-xl border-2 border-[#45495C] flex flex-col items-center justify-center transition-all duration-300 hover:border-fuchsia-500 hover:shadow-[inset_0_0_20px_#FB00FF] hover:-translate-y-2"
            >
            ...
            <button
              @click="seleccionarPersonaje('apocalipsis')"
              class="w-32 h-32 bg-[#161C37] rounded-xl border-2 border-[#45495C] flex flex-col items-center justify-center transition-all duration-300 hover:border-fuchsia-500 hover:shadow-[inset_0_0_20px_#FB00FF] hover:-translate-y-2"
            >
              <span class="font-pixel text-white text-[10px] leading-tight text-center"
                >APOCALIPSIS</span
              >
              <span class="font-pixel text-[#F7A129] text-[10px] leading-tight text-center"
                >Legendaria</span
              >
            </button>

            <button
              @click="seleccionarPersonaje('tecnoangel')"
              class="w-32 h-32 bg-[#161C37] rounded-xl border-2 border-[#45495C] flex flex-col items-center justify-center transition-all duration-300 hover:border-fuchsia-500 hover:shadow-[inset_0_0_20px_#FB00FF] hover:-translate-y-2"
            >
            ...
            <button
              @click="seleccionarPersonaje('nemesis')"
              class="w-32 h-32 bg-[#161C37] rounded-xl border-2 border-[#45495C] flex flex-col items-center justify-center transition-all duration-300 hover:border-fuchsia-500 hover:shadow-[inset_0_0_20px_#FB00FF] hover:-translate-y-2"
            >
            ...
            <button
              @click="seleccionarPersonaje('eclipse')"
              class="w-32 h-32 bg-[#161C37] rounded-xl border-2 border-[#45495C] flex flex-col items-center justify-center transition-all duration-300 hover:border-fuchsia-500 hover:shadow-[inset_0_0_20px_#FB00FF] hover:-translate-y-2"
            >
        ...
        <div class="grid grid-rows-[470px_auto] gap-4">
          <div class="w-[300px] h-[470px] bg-black/70 rounded-lg border-2 border-gray-500">
            <img
              ...
              :src="`/img/${personajeSeleccionado}.png`"
              alt="Personaje"
          ...
          <button
            v-if="personajeSeleccionado"
            class="w-[220px] h-12 mt-4 bg-[#2E1E3E] rounded-xl border-2 border-fuchsia-500 flex items-center justify-center justify-self-center gap-3 transition-all duration-300 hover:border-fuchsia-400 hover:shadow-[0_0_20px_#FB00FF] hover:-translate-y-2"
          >
            <img src="/img/iconos/moneda.png" class="w-6 h-6" />
            <span class="font-pixel text-white"> 12.000 </span>
          </button>
        </div>
      </div>
    </div>
