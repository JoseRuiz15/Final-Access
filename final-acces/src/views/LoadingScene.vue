...
const dialogos = [
  ...
  },
  {
    ...
    cuadro: '/img/textbox/textbox.png',
    texto:
      'Si escoges llaves incorrectas pierdes tiempo, escoge bien y escapa antes de que el contador llegue a 0.',
  },
  {
...
<template>
  <section @click="siguienteDialogo">
    ...
    <img
      :src="dialogos[dialogoActual].personaje"
      alt="loading"
      class="absolute top-[393px] left-[650px]"
    />

    <div class="absolute top-[200px] left-[850px]">
      <img :src="dialogos[dialogoActual].cuadro" alt="loading" class="w-[780px] h-[250px]" />
      <p
        class="absolute top-[20px] left-[50px] w-[700px] text-black font-pixel text-[20px] leading-8"
      >
        {{ textoMostrado }}
      </p>
    </div>
